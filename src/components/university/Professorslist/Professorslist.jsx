        ...
        <div className="col-md-6 col-lg-4" key={i}>
          <div className="team-member ">
            ...
            <div className="team-info">
              <h3>
                <NavLink to={BASEDIR + "/university/professor-profile"}>
              ...
              <ul className="social-icons list-inline list-unstyled">
                <li className="list-inline-item">
                  <a href={this.props.professors[i].facebook}>
                    <i className="i-social-facebook icon-primary icon-xs"></i>
                  </a>
                </li>
                <li className="list-inline-item">
                  <a href={this.props.professors[i].twitter}>
                    <i className="i-social-twitter icon-primary icon-xs"></i>
                  </a>
                </li>
                <li className="list-inline-item">
                  <a href={this.props.professors[i].linkedin}>
